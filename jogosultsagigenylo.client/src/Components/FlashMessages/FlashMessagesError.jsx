...
function FlashMessagesError(props) {
    ...
    if (keys.length > 0)
        return (
            <Container>
                <div id="flashmessage-error" key="flashmessage-error" className="w-1/5 fixed top-1/40 m-auto flex items-center bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded z-100" role="alert">
                    {
                        keys.map(key => {
                            return (
