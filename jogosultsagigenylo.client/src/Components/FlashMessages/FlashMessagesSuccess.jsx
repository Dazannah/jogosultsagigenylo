...
function FlashMessagesSuccess(props) {
    ...
    if (keys.length > 0)
        return (
            <Container>
                <div id="flashmessage-success" key="flashmessage-success" className="w-1/5 fixed top-1/40 m-auto flex items-center bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded z-100" role="alert">
                    {
                        keys.map(key => {
                            return (
